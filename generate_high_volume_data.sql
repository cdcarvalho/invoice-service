-- Inserir 1 milhão de contas com data_fechamento igual ao dia atual
INSERT INTO CONTAS (status, data_fechamento)
SELECT 'ABERTA', EXTRACT(DAY FROM CURRENT_DATE)
FROM generate_series(1, 1000000);

-- Inserir 2 milhões de lançamentos associados aleatoriamente às contas geradas
INSERT INTO LANCAMENTOS (conta_id, valor, data_lancamento)
SELECT 
    (random() * 999999 + 1)::BIGINT, -- Associa a uma das 1M contas criadas
